...
public class Addcategory {
	...
	public void init() {
		...
		if (browser.equalsIgnoreCase("chrome")) {
			System.setProperty("webdriver.chrome.driver", "Driver\\chromedriver100.exe");
	...
	public void AbletoAddCategory() {
		...
		driver.findElement(AbleToAddCategory).sendKeys("NEELAM2021");
	...
	public void NotAbleToAddDuplicate() throws InterruptedException {
		...
		By ClickonSelectColorButton = By.xpath("//span[contains(text(),'NEELAM2021')]");
